...
{
    public static IEnumerable<FsmVariableDoc> GetValue(this FsmBool fsmVar) =>
        fsmVar.GetValue(fsmVar.Name);
    public static IEnumerable<FsmVariableDoc> GetValue(this FsmBool fsmVar, string Property)
    {
