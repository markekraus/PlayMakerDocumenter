...
public record SetFsmGameObjectDoc : FsmActionDoc
{
    internal SetFsmGameObjectDoc(ActionContext Ctx, SetFsmGameObject action) : base(Ctx)
    {
...
{
    public static SetFsmGameObjectDoc Document(this ActionContext ctx, SetFsmGameObject Action) =>
        new(ctx, Action);
}
