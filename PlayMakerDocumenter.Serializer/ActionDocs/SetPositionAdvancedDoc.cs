...
public record SetPositionAdvancedDoc : FsmActionDoc
{
    internal SetPositionAdvancedDoc(ActionContext Ctx, SetPositionAdvanced action) : base(Ctx)
    {
...
{
    public static SetPositionAdvancedDoc Document(this ActionContext ctx, SetPositionAdvanced Action) =>
        new(ctx, Action);
}
