...
public record GetFsmVector3Doc : FsmActionDoc
{
    internal GetFsmVector3Doc(ActionContext Ctx, GetFsmVector3 action) : base(Ctx)
    {
...
{
    public static GetFsmVector3Doc Document(this ActionContext ctx, GetFsmVector3 Action) =>
        new(ctx, Action);
}
