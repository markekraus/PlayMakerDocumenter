...
public record SetFsmStringDoc : FsmActionDoc
{
    internal SetFsmStringDoc(ActionContext Ctx, SetFsmString action) : base(Ctx)
    {
...
{
    public static SetFsmStringDoc Document(this ActionContext ctx, SetFsmString Action) =>
        new(ctx, Action);
}
