...
public record SetFsmFloatDoc : FsmActionDoc
{
    internal SetFsmFloatDoc(ActionContext Ctx, SetFsmFloat action) : base(Ctx)
    {
...
{
    public static SetFsmFloatDoc Document(this ActionContext ctx, SetFsmFloat Action) =>
        new(ctx, Action);
}
