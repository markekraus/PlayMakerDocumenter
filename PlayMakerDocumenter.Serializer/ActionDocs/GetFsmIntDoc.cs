...
public record GetFsmIntDoc : FsmActionDoc
{
    internal GetFsmIntDoc(ActionContext Ctx, GetFsmInt action) : base(Ctx)
    {
...
{
    public static GetFsmIntDoc Document(this ActionContext ctx, GetFsmInt Action) =>
        new(ctx, Action);
}
