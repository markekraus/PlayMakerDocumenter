...
public record SetFsmIntDoc : FsmActionDoc
{
    internal SetFsmIntDoc(ActionContext Ctx, SetFsmInt action) : base(Ctx)
    {
...
{
    public static SetFsmIntDoc Document(this ActionContext ctx, SetFsmInt Action) =>
        new(ctx, Action);
}
