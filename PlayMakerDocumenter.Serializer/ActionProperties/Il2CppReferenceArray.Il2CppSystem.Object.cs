...
{
    public static void AddProperty(this FsmActionDoc action, string Property, Il2CppReferenceArray<Il2CppSystem.Object> Value)
    {
        ...
        {
            action.AddProperty($"{Property}[{i}].Type", Value[i].GetActualType().FullName);
        }
    }
}