...
{
    private static StringBuilder DocActionTrackStopAction(this StringBuilder sb, TrackStopAction action, ActionContext ctx) =>
        action is null
        ? sb
        : sb.AppendHeader($"{nameof(TrackStopAction)} Details:")
            .NewTable()
