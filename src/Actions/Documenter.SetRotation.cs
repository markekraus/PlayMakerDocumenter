...
{
    private static StringBuilder DocActionSetRotation(this StringBuilder sb, SetRotation action, ActionContext ctx) =>
        action is null
        ? sb
        : sb.AppendHeader($"{nameof(SetRotation)} Details:")
            .NewTable()
