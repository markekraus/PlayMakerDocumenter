...
$MDL = ".\Publish\PlayMakerDocumenter.ML.IL2CPP\PlayMakerDocumenter.Markdown.ML.IL2CPP.dll"
$Lib1 = "..\..\MelonLoader\Il2CppAssemblies\"
$Lib2 = "..\..\MelonLoader\net6\"

Remove-Item -Path $Path -Force -Recurse -ErrorAction SilentlyContinue
dotnet publish .\PlayMakerDocumenter.slnx -c ML_Cpp_CoreCLR
ilrepack.exe /target:library /lib:$Path /lib:$Lib1 /lib:$Lib2 /internalize /out:$Path/$Name $Path\$Name $MDU $Log $Util $Seri $MDL
