...
{
    private static StringBuilder DocActionGetPositionAdvanced(this StringBuilder sb, GetPositionAdvanced action, ActionContext ctx) =>
        action is null
        ? sb
        : sb.AppendHeader($"{nameof(GetPositionAdvanced)} Details:")
            .NewTable()
