...
{
    private static StringBuilder DocActionGetMouseButtonDown(this StringBuilder sb, GetMouseButtonDown action, ActionContext ctx) =>
        action is null
        ? sb
        : sb.AppendHeader($"{nameof(GetMouseButtonDown)} Details:")
            .NewTable()
