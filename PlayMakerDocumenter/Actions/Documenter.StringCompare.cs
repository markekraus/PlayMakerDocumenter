...
{
    private static StringBuilder DocActionStringCompare(this StringBuilder sb, StringCompare action, ActionContext ctx) =>
        action is null
        ? sb
        : sb.AppendHeader($"{nameof(StringCompare)} Details:")
            .NewTable()
